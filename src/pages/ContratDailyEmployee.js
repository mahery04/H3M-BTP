...
const ContratDailyEmployee = () => {
    ...
    const getContratDailyEmployees = (id) => {
        contratDailyEmployeeService.getAll(id).then((res) => {
    ...
    const saveContrat = e => {
        ...
        var data = {
            id: dailyemployee_id, 
            contrat_id: contratDailyEmployee.contrat_id,
        ...
        //     });
        // } else {
            axios.post('http://localhost:4000/api/contratdailyemployee', data)
            .then((res) => {
    ...
    const deleteDailyContrat = (id) => {
        ...
        .then((willDelete) => {
          if(willDelete) { 
            contratDailyEmployeeService.remove(id)
            const newTabList = contratLists.filter((dailyemployeecontrat) => dailyemployeecontrat.dailyemployee_id !== id)
...
export default ContratDailyEmployee