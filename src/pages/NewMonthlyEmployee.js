          ...
          <CardContent>
            <Box sx={{ flexGrow: 1 }}>
              ...
              <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                <Grid item xs={6}>
                  <TextField id="standard-basic" label="Numéro OSTIE" variant="standard" sx={{ width: '100%' }}/>
                </Grid>
                <Grid item xs={6}>
                  <TextField id="standard-basic" label="Numéro CNAPS" variant="standard" sx={{ width: '100%' }}/>
                </Grid>
              </Grid>
              <br /><br /><br />
              <Button
