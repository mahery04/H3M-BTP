    ...
    <div>
      ...
      <Container maxWidth="xxl">
        ...
        <Card sx={{ height: 500, width: '95%' }}>
          <CardContent>
            <Box sx={{ flexGrow: 1 }}>
              <Container maxWidth="sm" sx={{ lineHeight: 5 }}>
                ...
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                  <Grid item xs={6}>
                    <FormControl variant="standard" sx={{ width: '100%', marginTop: 1.7 }}>
                ...
                <TextField id="matricule" label="Historique" variant="standard" sx={{ width: '100%', marginTop: 1.7 }} />
