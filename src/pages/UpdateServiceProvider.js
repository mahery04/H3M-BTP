...
function UpdateServiceProvider() {
  ...
  const serviceProvider_id = findData.id
  ...
  useEffect(() => {
    const load = async () => {
      const res = await serviceProviderService.get(serviceProvider_id)
      setServiceProviders(res.data)
      setLoaded(true)
    }
    if (serviceProvider_id && !loaded) {
      load();
    }
  }, [serviceProvider_id, loaded])
  ...
  const savePersonnalProvider = e => {
    ...
    //   });
    // } else {
      serviceProviderService.update(serviceProvider_id,data).then(res => {
        setServiceProviders({
          id: res.data.id,
      ...
      navigate('/service-provider/personnal?updated')
    // }
  }
                  ...
                  <Grid item xs={2} sm={4} md={4}>
                    ...
                    <LocalizationProvider dateAdapter={AdapterDateFns}>
                      <DatePicker
                          ...
                          id="start_contract"
                          name="start_contract"
                          value={serviceProviders.start_contract}
                  ...
                  <Grid item xs={2} sm={4} md={4}>
                    ...
                    <LocalizationProvider dateAdapter={AdapterDateFns}>
                      <DatePicker
                          ...
                          id="end_contract"
                          name="end_contract"
                          value={serviceProviders.end_contract}
